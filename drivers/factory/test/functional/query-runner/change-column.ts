    ...
    it("should correctly change column and revert change", () =>
        Promise.all(
            connections.map(async (connection) => {
                ...
                expect(table!.findColumnByName("name")!.default).to.be
                    .undefined;
                ...
                table = await queryRunner.getTable("post");
                table!.findColumnByName("description")!.isPrimary.should.be
                    .true;
                ...
                expect(table!.findColumnByName("text")!.default).to.be
                    .undefined;
