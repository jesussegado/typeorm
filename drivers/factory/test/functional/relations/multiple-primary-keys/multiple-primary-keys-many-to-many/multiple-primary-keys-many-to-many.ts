        ...
        it("should load related entity when JoinTable used without options", () =>
            Promise.all(
                connections.map(async (connection) => {
                    ...
                    expect(loadedPosts[0].categories[1].name).to.be.equal(
                        "BMW"
                    );
        ...
        it("should load related entity when JoinTable references with non-primary columns", () =>
            Promise.all(
                connections.map(async (connection) => {
                    ...
                    expect(
                        loadedPosts[0].categoriesWithNonPKColumns[0].description
                    ...
                    expect(
                        loadedPosts[0].categoriesWithNonPKColumns[1].description
                    ...
                    expect(
                        loadedPosts[1].categoriesWithNonPKColumns[0].description
        ...
        it("should load related entity when both entities have multiple primary columns and JoinTable used without options", () =>
            Promise.all(
                connections.map(async (connection) => {
                    ...
                    expect(loadedTags[0].categories[0].name).to.be.equal(
                        "cars"
                    );
