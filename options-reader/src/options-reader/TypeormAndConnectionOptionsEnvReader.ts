...
import { TypeormAndConnectionOptions } from "typeorm-core/build/compiled/src/connection/Connection";
...
export class TypeormAndConnectionOptionsEnvReader {
     ...
     * Reads connection options from environment variables.
     */
    read(): TypeormAndConnectionOptions {
        return {
            connectionOptions: {
                type:
            ...
            typeORMOptions: {
                ...
                entities: this.stringToArray(
                    getEnvVariable("TYPEORM_ENTITIES")
                ),
                ...
                logging: this.transformLogging(
                    getEnvVariable("TYPEORM_LOGGING")
                ),
